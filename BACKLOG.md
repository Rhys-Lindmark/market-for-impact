...
- [ ] **MFI-005 — Ship organization and grant detail pages.** Add stable URLs, source citations, grant timeline, evaluator comparisons, metric provenance, and data freshness.
  ...
  - [ ] Add a many-to-many organization/grant relationship table before linking the complete Coefficient index’s free-text and multi-recipient rows to canonical organization profiles; do not silently select one recipient from grouped names.
