...
export default function Page(){return <><CharityResearchReport content={content}/><GiveWellComparison slug="new-incentives"/><LocalImpactNote slug="new-incentives" directQ={central.netGlobalQaly} gift={data.giftUsd}/></>;}
