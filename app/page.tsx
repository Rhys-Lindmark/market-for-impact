...
export default function SanFranciscoHome(){
  return <div className="sf-home givebetter">
    ...
    <main>
      ...
      <footer className="sf-home-footer"><a href={`${root}/research`}>Bay Area research</a> · <a href={`${root}/editions`}>All research: cities and regions</a><p>Independent research. Not affiliated with GiveWell or the organizations reviewed.</p></footer>
    </main>
  </div>;
}
