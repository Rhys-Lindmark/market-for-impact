...
export default function ResearchIndex(){
 return <div className="givebetter"><header className="givebetter-masthead"><a href="/">Give<span>Better</span> <small>x SF</small></a></header><main className={styles.shell}>
  ...
  <p className={styles.expenseNote}>Expenses average three consecutive verified fiscal years (shown beneath each figure), including programs, administration and fundraising—not just the activity modeled here. Some windows are historical while newer filings await review. Select a figure for sources and accounting scope. Missing records and fiscal-sponsor totals are not treated as organization budgets.</p>
