...
export default function ResearchIndex(){
 return <div className="givebetter"><header className="givebetter-masthead"><a href="/">Give<span>Better</span> <small>x SF</small></a></header><main className={styles.shell}>
  <section className={styles.intro}><h1>GiveBetter x SF Research</h1><p>Estimated dollars per better life in the San Francisco Bay Area (10 QALYs).</p><p className={styles.caveat}>These are uncertain research estimates, not verified donation offers. Cost boundaries differ; see each report before comparing.</p><p><a href="/#giving-priorities">Our ten giving priorities</a> · <a href="/research/city-theory">What we learned from 100 reports</a></p></section>
