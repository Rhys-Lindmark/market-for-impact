...
const topResearchPrograms = [
  ...
  { organization: 'Hamilton Families', program: 'Homelessness prevention', overview: 'Flexible assistance and case management intended to avert family homelessness.', price: '≈ $500,000', unit: 'per additional six-month homelessness episode averted', betterLifePrice: 'Not yet convertible', bridgeState: 'Eight evidence gates failed', evidence: 'Very uncertain', detail: 'A VA model offers a numeric external QALY comparator, but its veteran population, payer costs, housing trajectory, mortality, and utility assumptions do not establish Hamilton impact.', href: '/charities/hamilton-families' },
  { organization: 'Compass Family Services', program: 'C-Rent homelessness prevention', overview: 'Back-rent and move-in assistance paired with case management and problem-solving for at-risk families.', price: '≈ $485,000', unit: 'per additional six-month homelessness episode averted', betterLifePrice: 'Not yet convertible', bridgeState: 'Eight evidence gates failed', evidence: 'Audited cost; transferred effect', detail: 'Audited accounting anchors the native cost, but a VA QALY model cannot transfer its veteran housing trajectory, payer costs, mortality, or utility assumptions to Compass families.', href: '/charities/compass-family-services' },
  ...
  { organization: 'Five Keys Schools and Programs', program: 'Secondary-credential pathway', overview: 'Accredited, flexible high-school and equivalency instruction in custody and community settings for learners traditional schools did not retain.', price: '≈ $167,000', unit: 'per additional credential in a modeled 10-point scenario', evidence: 'Audited cost; causal effect unmeasured', detail: 'The $16,700 cost anchor is per ADA-equivalent year. The credential effect is a transparent decision scenario—not a Five Keys estimate—and a null remains plausible.', href: '/charities/five-keys' },
];
