...
const canonicalResearchRoutes = new Map([['sf-lgbt-center', '/charities/sf-lgbt-center'], ['sf-marin-food-bank', '/charities/sf-marin-food-bank'], ['hamilton-families', '/charities/hamilton-families'], ['glide', '/charities/glide'], ['compass-family-services', '/charities/compass-family-services'], ['curry-senior-center', '/charities/curry-senior-center'], ['eviction-defense-collaborative', '/charities/eviction-defense-collaborative'], ['farming-hope', '/charities/farming-hope'], ['five-keys-schools-and-programs', '/charities/five-keys']]);
