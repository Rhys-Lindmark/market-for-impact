# Friends of the Urban Forest: whole-organization exploratory assessment

Review date: September 11, 2026. Legal organization: Friends of the Urban Forest, EIN 94-2699528. Status: exploratory estimate; hold a giving recommendation pending funding and health evidence. This report concerns an ordinary gift to FUF, not a restricted contract to buy a specified number of trees.

## Summary

**What do they do?** Friends of the Urban Forest plants and establishes street trees in San Francisco, maintains young trees, installs sidewalk gardens, and runs community and workforce programs. Its official FY2025 impact report describes 1,506 new street-tree plantings, 2,598 tree-care visits, and approximately 1,200 trees watered weekly. These are different activities, not three independent groups of health beneficiaries. All $5,410,095 of FY2025 reported organization expense is included in our cost denominator. Only the street-tree health pathway is quantified; other programs remain in cost without separately credited health benefits. [More](#organization-and-scope)

**Why consider it?**

- Delivery is real and locally concentrated. The official annual report and a separate city report agree to within four trees on FY2025 planting volume. Establishment care and work in low-canopy neighborhoods offer a plausible path from planted trees to durable environmental exposure.
- Trees could affect heat exposure, mental health, pollution, and physical activity. Experimental greening evidence supports some mechanisms, although it does not measure FUF's health effect or isolate an equivalent street-tree intervention.
- A modest probability of meaningful neighborhood-wide benefit can matter. Our model permits this possibility while including explicit null and harmful scenarios rather than treating every planting as beneficial. [More](#health-evidence)

**Why hold a recommendation?**

- No primary source identifies QALYs per surviving San Francisco street-tree-year. The central 0.010 and favorable 0.040 values are unvalidated analyst judgments, not measured effects or numerical conversions from the Portland mortality paper.
- The favorable scenario has only 10% subjective weight but supplies 84.9% of modeled net expected QALYs. Removing it and renormalizing the other weights raises the modeled cost to about $5.60 million per 10 QALYs.
- Publicly funded planting and maintenance are a substantial baseline. New city sources document a funded pipeline beyond the old contract's August 2025 end date. They do not identify a currently unfunded, priced tranche that an additional ordinary gift would cause.
- New plantings need not mean a one-for-one increase in trees relative to the counterfactual: some replace failed trees, some would be funded anyway, and benefits depend on survival and maturation. [More](#funding-and-counterfactual)

**How much does an additional gift accomplish?** Our source-updated, signed, probability-weighted illustration estimates **$941,689 per 10 modeled Bay QALYs**, versus $1,053,267 previously. The central scenario alone is **$1,652,627**; it is not the weighted estimate. The update changes only the matched accounting expense and annual output denominator: FY2025 expense is lower and reported street-tree volume higher than the previously credited FY2024 figures. All scenario weights, funding responses, health scalars, survival, horizons, and harms are unchanged. This numerical threshold crossing is not evidence that funding room or clinical effectiveness became verified. [More](#model-and-results)

**What does the money include?** The donor illustration charges the full accrual-accounting expense of the legal organization, not just planting program expense. It is an expense proxy for gift allocation, not verified cash expenditure or a complete societal resource total. City maintenance, volunteer opportunity cost, resident time, and infrastructure effects are incompletely valued. The inherited gross-resource sensitivity gives about $1.090 million per 10 QALYs, but its multiplier is itself a judgment rather than an audited resource inventory. [More](#finances-and-resources)

**Monitoring and remaining evidence.** The most valuable next evidence would link an approved but unfunded site cohort to a dated additional-gift budget, survival and growth follow-up, and a credible estimate of the time or tree exposure gained relative to existing city and private funding. A general donation page and an accounting deficit do not establish this. No outreach has been sent and no marginal offer is verified. [More](#monitoring-and-decision)

**Qualitative considerations.** Low-canopy neighborhood targeting, practical maintenance, workforce opportunities, community participation, and non-health ecological benefits may matter to a donor. We neither turn them into invented QALYs nor claim they have no value. Conversely, allergen exposure, damaged sidewalks, water and maintenance demands, and displacement-related burdens warrant attention. This is a whole-cost, partial-health assessment with a transparent but weakly calibrated quantitative bridge. [More](#limitations-and-qualitative-judgment)

**What would change our view?** A documented gift-funded tranche with approved sites and maintenance commitments would improve the funding assessment, but not by itself validate the health scalar. Conversely, evidence that the same trees are already financed, or that private gifts mainly replace another payer, would reduce expected additionality. Local survival and growth data could move the exposure estimate in either direction: a historical San Francisco study reports substantial long-term survival, while the relationship between survival and mature health-producing canopy remains uncertain. These are distinct questions, and a strong answer to one should not be used to silently fill the others.
...
The annual delivery and resource counts above come from the [FY2025 official impact report](https://www.friendsoftheurbanforest.org/_files/ugd/f2e7e3_ae868b6ce3ba4db3a155370c490f0046.pdf), compared with the [July 10, 2025 city presentation](https://sfpublicworks.org/sites/default/files/Commissions/July%2010%202025/Item_6%20PWC%20Workforce%20Development%20Grants%20Update%207-10-25%20v710.pdf). The separate funded program is described on the [yard-tree page](https://www.friendsoftheurbanforest.org/adopt-a-yard-tree).
...
| Reported dollars | FY2023 | FY2024 | FY2025 |
|---|---:|---:|---:|
| Total revenue | 4,217,920 | 5,006,971 | 5,142,060 |
| Whole expense | 4,655,009 | 5,673,426 | 5,410,095 |
| Program services | 3,299,016 | 4,136,547 | 3,984,632 |
| Management and general | 663,236 | 764,372 | 867,580 |
| Fundraising | 692,757 | 772,507 | 557,883 |
| Government grants, included in revenue | 2,917,846 | 3,418,485 | 3,761,445 |
...
Accounting sources: original [FY2023 return](https://projects.propublica.org/nonprofits/full_text/202440179349300544/IRS990), [FY2024 return](https://projects.propublica.org/nonprofits/full_text/202541029349300739/IRS990), and [FY2025 return](https://projects.propublica.org/nonprofits/full_text/202611049349302071/IRS990). The differing public summary is on page 12 of the official impact report linked above.
...
These denominator and age distinctions are checked against the [Portland primary paper](https://research.fs.usda.gov/download/treesearch/65639.pdf), rather than a news summary.
...
The trial's design and reported outcomes are available in the [primary article record](https://pubmed.ncbi.nlm.nih.gov/30646029/).
...
The biomarker description is the research team's [Green Heart project report](https://centers.louisville.edu/envirome/featured-research-projects/green-heart-louisville-project), not a mortality trial result.
...
The later funding evidence is in the [SFCTA project account](https://www.sfcta.org/blogs/transportation-sales-tax-funds-cable-cars-trees) and [November 2025 Public Works newsletter](https://www.sfpublicworkstv.org/november2025). The [general giving page](https://www.friendsoftheurbanforest.org/support-us) confirms a donation route, not a marginal quote.
...
| Scenario | Weight | Funding response | Establishment survival | Annual mortality | Years | QALY/tree-year | Harm/tree |
|---|---:|---:|---:|---:|---:|---:|---:|
| Harm | 25% | 15% | 50% | 9.3% | 8 | 0 | 0.020 |
| Null | 35% | 10% | 50% | 9.3% | 8 | 0 | 0 |
| Central | 30% | 40% | 75% | 6.0% | 12 | 0.010 | 0.002 |
| Favorable | 10% | 75% | 90% | 2.8% | 20 | 0.040 | 0.0006 |
...
| Diagnostic, not a revised preferred estimate | Dollars per 10 modeled Bay QALYs |
|---|---:|
| Preferred source update | 941,689 |
| City count of 1,502 instead of 1,506 | 944,197 |
| Half the funding response in every world | 1,883,378 |
| Half net-new beneficial tree exposure; harms retained | 1,935,901 |
| No health benefit in first three modeled years | 1,275,100 |
| Linear onset reaching full scalar at year ten | 1,459,169 |
| Bay share 95%; nested SF share 90% | 991,252 |
| Every horizon capped at ten years | 1,390,883 |
| Remove favorable world and renormalize remaining weights | 5,602,188 |
| Zero health scalar, harms retained | Net harm; no positive cost-effectiveness ratio |
