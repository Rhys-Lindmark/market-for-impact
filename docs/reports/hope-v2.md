...
**What do they do?** HOPE is a Pacifica community nonprofit combining overdose-prevention access, education, family resources and remembrance. Its strongest modeled pathway is getting usable naloxone into a network where it could change an otherwise fatal emergency. Current official information identifies nine distribution locations across Pacifica, Half Moon Bay, San Bruno, Belmont, South San Francisco and San Francisco. This is evidence of a real access network, not a count of unique people protected or rescues caused. [More](#1-organization-and-current-delivery)

**Reasons to investigate:**

- A small local organization may solve last-mile access and stocking problems using medication supplied through public programs.
- A timely response to an opioid overdose can have a large health consequence; low organizational expense could make even a small additional effect worthwhile.
- There are specific sites and an adopted historical installation grant, rather than only an aspiration to launch a service.

**Reservations and giving status:**

- HOLD giving recommendation: no original annual expense, dated unique risk cohort or priced additional-capacity plan has been verified.
- Current county provision includes free distribution hardware as well as a route to free medication. A donor must identify what HOPE adds beyond that baseline.
...
**Monitoring.** The earlier cached dedicated page said over 3,000 distributions and listed fewer sites. At the September 11, 2026 review, the dedicated page reported over 6,000 distributions, matching the homepage, and listed nine locations. That resolves a current-page discrepancy, but not the unit, time period, annual flow, repeat use or beneficiary network. We found no annual cohort or local causal outcome evaluation. Count reconciliation and a small, carefully designed follow-up would be more informative than another cumulative milestone. [More](#3-monitoring-and-the-unique-person-denominator)

**Qualitative assessment.** The local network could have value even when the medication and box are publicly supplied: choosing a neglected site, arranging permission, keeping stock usable and accessible, and building trust can matter. Conversely, an existing host may obtain the same box and stock without HOPE or an additional donation. The public evidence supports both possibilities. A general fundraising appeal does not settle between them. Community support and remembrance may be important, but no invented grief utility or treatment-completion benefit is added. [More](#7-qualitative-judgment-and-strongest-alternative)

The model gives each person one finite survival trajectory. Repeat packs reduce unique coverage; they do not create repeated lives saved. Nevertheless, about 92% of central gross modeled survival benefit occurs after the one-year active access window. That is a consequence of a persistent survival gap under common subsequent mortality, not continuing organizational protection. It makes later prognosis consequential and explains why short-horizon diagnostics are much worse. Neither the long horizon nor its utility value is locally measured.

The absence of annual statements is equally material. The latest IRS-derived index contains no return, and its administrative small-filer code is not an expense measurement. We cannot provide a truthful three-year spending trend or verify whether a small gift supplements or displaces existing resources. Those limitations remain visible rather than being filled with the installation grant.

The county’s current hardware program materially changes the funding question. It changes the diligence question from “can a charity buy a cheap box?” to “which useful access gap would remain after public hardware, medication and existing partners?” The appropriate next step is a reconciled whole budget, a dated coverage ledger, and a small additional-gift plan identifying that gap. No outreach has been sent. A deeper report makes the uncertainties inspectable; it does not turn absent measurements into evidence.

## 1. Organization and current delivery

### Legal and program boundary

HOPE’s legal identity is distinct from Pacifica Resource Center, which appears as one access location, and from unrelated charities named HOPE. The official mission covers education, support and advocacy as well as overdose prevention. We evaluate the ordinary legal recipient, not a hypothetical naloxone-only affiliate. An unrestricted donation may support events, transport, administration, insurance, memorial work or distribution. Charging only dispenser hardware while assigning the whole nonprofit’s benefits would misstate the donation being evaluated. [Official mission](https://www.hope4change650.org/about)
...
## 2. Finances and the public-resource boundary
...
The program’s January 29, 2026 launch notice and current application route are more relevant to today’s comparator than a 2025 statement that few dispensing machines existed. We do not infer that the original grant was unnecessary when awarded. Counterfactuals change over time. A previously additional installation model can become less additional as public provision expands, even if the organization continues doing worthwhile work. [Launch notice](https://www.smchealth.org/post/overdose-prevention-coalition-launches-naloxone-program-expands-free-access-county)
...
## 3. Monitoring and the unique-person denominator
...
## 4. Causal evidence and finite health
...
Historical post-overdose cohorts have high subsequent mortality. Larochelle reported 4.7 all-cause deaths per 100 person-years; Olfson reported 7.783 in a first-year cohort. These are selected survivors of an overdose, not the average person indirectly reached by a dispenser. Age, substance use, treatment, calendar period and selection all affect the transfer. We retain these studies only as historical scale context, not as a measurement of HOPE’s baseline or ten-year prognosis. [Larochelle](https://pubmed.ncbi.nlm.nih.gov/29913516/) [Olfson](https://pubmed.ncbi.nlm.nih.gov/29926090/)
...
| Observed annual expense | Unknown | Unknown |
| Current listed sites | Five in prior inspected evidence | Nine in native dedicated page |
| Annual unique risk people | Unknown | Unknown |
| Verified marginal offer | None located | None located |
...
| Diagnostic | Weighted dollars/10 Bay QALYs |
| --- | ---: |
...
## 6. What would an additional donation change?
...
## 7. Qualitative judgment and strongest alternative
