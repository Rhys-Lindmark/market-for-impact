# SPUR V2: a whole-organization, partial-health assessment

Assessment date: September 11, 2026. Legal recipient: SPUR — San Francisco Bay Area Planning and Urban Research Association, EIN 94-1498232. This is a public-source research refresh, not a new organization, a verified funding offer, or an independent evaluation commissioned by SPUR. It covers an ordinary unrestricted gift across the organization; clean heat is only one pathway. Financial periods, source dates and model assumptions are distinguished below.

## Summary

**What do they do?** SPUR is worth understanding as an institution that may improve decisions affecting many Bay Area residents, not as a provider selling a fixed quantity of health care. Its potential advantage is leverage: useful research, administrative implementation and coordination could improve housing availability, transportation and environmental health at a scale far larger than its own operating budget. Its central difficulty for a donor is the same leverage in reverse. Public agencies, developers, other advocates, prior SPUR work and already committed funding contribute to the outcomes. Neither a policy victory nor the population covered by a rule tells us how much health the next gift causes.

**What do you get for your dollar?** Our retained central illustration for a hypothetical $100,000 unrestricted gift is **0.4564 Bay QALYs, including 0.09214 in San Francisco**, or approximately **$2.19 million per 10 Bay QALYs**. Ten QALYs means ten years of life in full health, or an equivalent combination of duration and health quality across people; it is not necessarily one person treated. The Bay and SF totals are nested, not additive. This is a conditional central scenario, not a probability-weighted expected return. We have not assigned probabilities to the joint scenarios, and the executable model returns no weighted expectation rather than presenting an arbitrary average.

At this gift size, beating $1 million per 10 QALYs requires more than one net Bay QALY; the central illustration falls below that level. This is a decision threshold, not a reason to adjust the assumptions until they pass. The annual financial budget is a separate denominator: dividing it by the hypothetical gift and scaling all health proportionally would assume an organizational production function that has not been established. The model therefore makes an ordinary-gift portfolio judgment, not a measured average return on every dollar SPUR has ever spent.

The scope is genuinely organizational but the quantified health is incomplete. One shared gift supports housing/planning, transportation, clean heat/environment, governance/procurement and economic security. Housing, transit and heat have finite illustrative health pathways. Other activity remains inside the cost allocation but unquantified. That does not mean governance, resilience, public education or economic security has zero value. It means this review cannot credibly measure that value with the same health unit. Institutional knowledge can also be useful across topics without justifying another full health benefit for each report that cites it.

**What information has SPUR shared?** This refresh strengthens several boundaries rather than making the headline more favorable. It inspects the latest three posted tax filings, distinguishes original and restated financial statements, identifies netted event expenses, and separates organization-wide spending from the assumed allocation of an additional gift. It also adds an official city housing-production model that distinguishes legal capacity from likely construction and subtracts lost homes. Crucially, that city model is not evidence for SPUR’s marginal causal share. Its earlier policy comparator is different from the question a donor faces after the policy has already been adopted.

Housing remains the largest central pathway. New occupied housing can help occupants and other renters, but the health gain depends on who experiences a meaningful improvement in crowding, insecurity or another harmful state. It is not enough to count all new occupants as newly housed from homelessness or convert every dollar of rent savings into QALYs. Relevant rental-assistance evidence is not uniformly positive under stronger within-person comparisons, and market-rate supply changes are a different intervention. The current direct and spillover utility coefficients therefore remain explicitly judgmental.

Transit and clean heat have plausible physical mechanisms, but their delivery denominators are also uncertain. Additional useful service can change access or activity; scheduled hours and gross ridership are not unique beneficiaries. Earlier removal of combustion can reduce population pollution exposure; faster permits are not necessarily earlier conversions. Existing funding and regulatory implementation must be included in both counterfactuals. Construction, appliances and public operations are not free resources merely because SPUR does not pay their invoices.

**Our bottom line.** We would not currently select an unrestricted SPUR gift as a demonstrated leading Bay-health opportunity. The favorable joint scenario is much better than the central case, but assumes favorable output, contribution and health effects together. There is no verified additional-gift workplan establishing those conditions. Conversely, the unfavorable central illustration does not establish that SPUR is ineffective or that its wider civic benefits are small. The most valuable next evidence would be a prospective implementation ledger linking a realistic ordinary-gift allocation to earlier physical outcomes, the public baseline, and measured or defensible finite health exposure. Until then, retain SPUR as a transparent, low-confidence policy research option, not a priced health purchase.

**Why we consider it worth further research:**

- Housing, transit and clean heat can affect many residents. [More](#4-causal-evidence-and-transfer)
- Published financial records make organization-level costs inspectable. [More](#2-what-does-the-spending-record-establish)

**Our main reservations:**

- Additional policy outcomes attributable to a new gift remain judgments, not measured effects. [More](#5-whole-gift-economics-and-finite-model)
- Existing public funding and adopted policies constrain additional impact. [More](#6-additional-funding-and-realistic-alternatives)

## 1. What does the organization actually do?

### The unit being assessed

The [official financial-disclosure page](https://www.spur.org/about/financial-statements) identifies the charitable legal entity and explains its April–March reporting year. SPUR is not SPURR, the separate public procurement organization. The model does not assign benefits of unrelated organizations with similar names. Nor does it create separate charity entries for SPUR’s topic areas or offices.
...
The [Metropolitan Transportation Commission’s January 30, 2026 agreement](https://mtc.ca.gov/news/agreement-reached-loan-bay-area-transit-agencies) identifies a $590 million bridge loan, negotiated with the state and operators, for the FY2026–27 operating gap. This is a major funded baseline. The agreement is evidence of public resources and multiple decision-makers, not evidence that a current SPUR gift causes the full loan or all riders’ benefits. Loan principal is also a financing flow, not automatically the economic resource cost of all transit service.

### Clean heat and environment

SPUR’s [August 6, 2026 heat-pump update](https://www.spur.org/news/2026-08-06/three-measures-drive-down-high-cost-heat-pump-installation) discusses installation barriers. The earlier [Greenlighting Clean Heat brief](https://www.spur.org/publications/policy-brief/2025-06-06/greenlighting-clean-heat) offers permitting reforms. These sources support a current implementation subject, not an observed number of additional conversions attributable to a donor.
...
## 2. What does the spending record establish?
...
| Tax label / fiscal year ended | Program | Management/general | Fundraising | Form 990 functional expenses |
|---|---:|---:|---:|---:|
| [2022 / March 31, 2023](https://www.spur.org/sites/default/files/2024-01/SPUR_2022_Form_990.pdf), Part IX | $6,457,918 | $881,936 | $1,097,645 | $8,437,499 |
...
## 3. Delivery and monitoring: what is known, and what remains missing?
...
The [current Air District rule-development page](https://www.baaqmd.gov/en/rules-and-compliance/rule-development/building-appliances?sc_lang=en) is the relevant baseline record, including implementation work and proposed amendments. Draft flexibility is not automatically an adopted exemption; a tentative future decision is not an implemented result. A model based on an obsolete schedule could overstate or understate the acceleration window. This V2 does not infer a new exact regulatory timetable from old SPUR text.

A more concrete public baseline is now available. The [March 18, 2026 C/CAG packet](https://ccag.ca.gov/wp-content/uploads/2026/03/RMCP-full-packet-031826.pdf), item 5, identifies a **BayREN Codes and Standards-funded** San Mateo County permit-simplification pilot, scheduled to launch April 1 with seven jurisdictions. It does not report completed installations or a SPUR grant requirement. This supports the reality of implementation work while weakening any assumption that a new donor must fund the pilot from scratch. A later evaluation could distinguish incremental adoption from improved documentation; the March packet itself does not.
...
For procurement, an [October 7, 2025 Board President release](https://sfbos.org/sites/default/files/Press_Release-Contract_Streamlining_Act_October_2025.pdf) independently acknowledges SPUR's report in describing Board passage of contracting reform, then pending mayoral signature. It also traces the process to a 2022 request and 2024 City Administrator response, before the April 2025 SPUR publication. That chronology supports contribution rather than sole initiation. The release reports a legislative step, not measured faster contracts, better services or additional health. An ordinary gift now would need a residual implementation role beyond that baseline.

## 4. Causal evidence and transfer
...
A fresh abstract check of [Bentley et al.](https://pubmed.ncbi.nlm.nih.gov/21821543/) identifies 10,047 Australian adults and a fixed-effects comparison of transitions into unaffordable housing. The lower-income group’s SF-36 mental-component change was −1.19 points (95% CI −1.97 to −.41); the higher-income group did not show the same association. This supports heterogeneity rather than a universal occupant benefit. SF-36 mental-component points are not SF-6D utilities. No transformation from that score to our .01 or .001 coefficients was established, and none is applied.
...
## 5. Whole-gift economics and finite model
...
| Joint scenario | Bay QALYs per $100,000 | Donor dollars per 10 Bay QALYs |
|---|---:|---:|
| Central, retained | .4564 | $2,191,060 |
| Favorable, retained | 51.64 | $19,365 |
| Pessimistic positive | .0002498 | $4,003,202,562 |
| Null contribution | 0 | No positive ratio |
| Null physical output | 0 | No positive ratio |
| Central plus donor-specific harm | −.2436 | No positive ratio |
| Null contribution plus donor-specific harm | −.7 | No positive ratio |
| Central, no housing spillover | .3964 | $2,522,704 |
| Favorable, no housing spillover | 21.64 | $46,211 |
...
## 8. Revision record and acceptance status
...
| Pathway / input | Central | Favorable | Pessimistic positive |
|---|---:|---:|---:|
| housing: conditionalSfOccupiedHomeYears | 1000 | 5000 | 100 |
| housing: conditionalRestBayOccupiedHomeYears | 3000 | 15000 | 300 |
| housing: netGiftContribution | 0.02 | 0.05 | 0.002 |
| housing: peoplePerDirectHomeYear | 2 | 2 | 1 |
| housing: improvedStateFraction | 0.15 | 0.3 | 0.05 |
| housing: directUtility | 0.01 | 0.02 | 0.002 |
| housing: spilloverHouseholdYearsPerHomeYear | 0.5 | 2 | 0.1 |
| housing: adultsPerSpilloverHousehold | 1.5 | 1.5 | 1 |
| housing: spilloverUtility | 0.001 | 0.01 | 0.001 |
| transit: conditionalSfUsefulServiceHours | 5000 | 50000 | 500 |
| transit: conditionalRestBayUsefulServiceHours | 15000 | 150000 | 1500 |
| transit: netGiftContribution | 0.02 | 0.05 | 0.001 |
| transit: marginalTripsPerServiceHour | 20 | 40 | 10 |
| transit: tripsPerRecurrentRiderYear | 400 | 400 | 400 |
| transit: healthRelevantFraction | 0.1 | 0.25 | 0.02 |
| transit: netQalyPerChangedRiderYear | 0.005 | 0.01 | 0.001 |
| heat: conditionalRegionalExposureFraction | 0.002 | 0.01 | 0.0002 |
| heat: implementationProbability | 0.5 | 0.7 | 0.2 |
| heat: giftAttribution | 0.1 | 0.2 | 0.02 |
| heat: effectiveDiscountedMortalityYears | 3 | 5 | 1 |
| heat: modeledRegionalDeathsPerYear | 61 | 85 | 37 |
| heat: qalyPerDeath | 8 | 12 | 3 |
| heat: sfHealthShare | 0.1 | 0.15 | 0.05 |
| donorSpecificHarm: sfQaly | 0 | 0 | 0 |
| donorSpecificHarm: restBayQaly | 0 | 0 | 0 |
