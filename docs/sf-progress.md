...
Active block started 2026-09-08T01:42:36Z; target90 measured minutes without padding. Previous block made authoritative progress: DOPE #168 accepted as PR #169 / Sites v120; 28-review canonical ranking verified. Current mechanism-first2 is HealthRIGHT360 access #170 (not an unsupported retention effect). Its model, report, native workbook and local validation are complete; release acceptance pending. Next: SF Community Health Center HCV navigation. Earlier SFAF/PHC work remains comparator evidence, not extra original-cohort rows.
