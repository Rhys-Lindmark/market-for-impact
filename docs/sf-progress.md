...
Active block started 2026-09-08T01:42:36Z; target90 measured minutes without padding. Previous block made authoritative progress: DOPE #168 accepted as PR #169 / Sites v120; 28-review canonical ranking verified. Current mechanism-first2 is HealthRIGHT360 access #170 (not an unsupported retention effect). Accepted PR #171 / Sites v121 at 7704842185383ad24cdf21ffceb41adbaab8d315; canonical 29-review ordering and report/API passed. Mechanism-first3 SFCHC integrated HCV access #172 is implemented and independently audited; local tests, lint/build, four phone/tablet checks and native workbook A211:E243 passed. SFCHC accepted as PR #174 / Sites v122 at b28297233fcd4cb05f4de9a2abf1523504935d91; 30-review canonical ranking and report/API verified. NEMS adult HBV is implemented in PR #176 with 248 unit tests, lint/build, independent audit, native workbook A245:E266 and focused mobile checks passed; full CI release gate pending after homepage-test update. Six remaining mechanism-first leads plus broader vaccination, ten unconventional entity leads, and policy/child handoffs are preserved in docs/research-drafts and PR #177. Drafts are not accepted models or funding offers. Next: release NEMS, then integrate remaining mechanism models. Child-health research leads preserved in #173; do not inflate organization counts. Earlier SFAF/PHC work remains comparator evidence, not extra original-cohort rows.
