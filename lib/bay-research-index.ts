import {calculate as faceToFaceModel} from './face-to-face-model.mjs';
const faceToFace=faceToFaceModel();
import {calculate as oaklandEdcModel} from './oakland-edc-model.mjs';
const oaklandEdc=oaklandEdcModel();
import {calculate as onSiteModel} from './on-site-dental-model.mjs';
const onSite=onSiteModel();
import {calculate as hifModel} from './hif-model.mjs';
const hif=hifModel();
import {calculate as batsModel} from './bats-model.mjs';
const bats=batsModel();
import {calculate as dowModel} from './dentists-on-wheels-model.mjs';
const dow=dowModel();
import {calculate as pacificHearingModel} from './pacific-hearing-v2-model.mjs';
...
import {calculate as recaresModel} from './recares-v2-model.mjs';
