export const inputs = {
  modelVersion: "nurse-family-partnership-v2-unit-aligned",
  gift: 100000,
...
function validateInputs(modelInputs) {
  ...
  if (modelInputs.modelVersion !== "nurse-family-partnership-v2-unit-aligned") {
    throw new RangeError("inputs.modelVersion must preserve the accepted v2 unit-aligned model");
  }
...
export function calculate(modelInputs = inputs, scenarioInputs = scenarios) {
  ...
  const results = scenarioInputs.map((scenario) => {
    ...
    const externalResources = realizedFullCourseEquivalents * externalResourcesPerFullCourse;
