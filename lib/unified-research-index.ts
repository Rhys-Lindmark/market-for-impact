...
export const unifiedResearch=[
 ...
 ...usResearch.map(r=>({organization:r.organization+' (U.S.)',program:r.program,href:r.href,scope:'US',sfUsdPerTenQalys:r.href==='/charities/remedy-alliance'?remedyLocalScenarios[0].sfUsdPer10Q:null as number|null,localStatus:'Very uncertain local-share judgment; see report'})),
