...
test('AMF global benefits never enter SF ranking and retain donor cost',()=>{
 ...
 const page=fs.readFileSync('app/research/page.tsx','utf8');assert.match(page,/SF or Bay Area QALYs/);assert.doesNotMatch(page,/globalUsdPer10Qaly/);
 const archive=fs.readFileSync('app/archive/international-research/page.tsx','utf8');assert.match(archive,/internationalResearch/);assert.match(archive,/No direct Bay Area health benefit is credited/);
});
