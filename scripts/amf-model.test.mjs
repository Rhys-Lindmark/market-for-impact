...
test('AMF global benefits never enter SF ranking and retain donor cost',()=>{
 ...
 const page=fs.readFileSync('app/research/page.tsx','utf8');assert.match(page,/International organization research/);assert.match(page,/No direct Bay Area benefit/);
});
