...
import {calculate as breathe} from '../lib/breathe-coverage-model.mjs';
...
test('fourteen explicit Bay adapters match model outputs',()=>{
 ...
 const expected={
  'breathe-california':breathe(read('breathe-coverage-v2.json'),central(read('breathe-coverage-v2.json'))).bay.donor_per_10q,
