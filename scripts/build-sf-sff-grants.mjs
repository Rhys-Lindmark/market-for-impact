...
const [source, fiscalSponsorSource, currentReceivingEntityReviews, irsUniverse, candidateUniverse, diligence] = await Promise.all([
...
const snapshot = validateSfSffGrants(buildSfSffGrants({ source, fiscalSponsorSource, currentReceivingEntityReviews, irsUniverse, candidateUniverse, diligence }));
