...
const [source, fiscalSponsorSource, currentReceivingEntityReviews, serviceGeographyReviews, candidateDiligenceReviews, irsUniverse, candidateUniverse, diligence] = await Promise.all([
  ...
  read('data/san-francisco/sff-candidate-diligence-reviews.json'),
...
const snapshot = validateSfSffGrants(buildSfSffGrants({ source, fiscalSponsorSource, currentReceivingEntityReviews, serviceGeographyReviews, candidateDiligenceReviews, irsUniverse, candidateUniverse, diligence }));
