...
import {calculate,survivalQ} from '../lib/glide-coverage-model.mjs';
import {scenarios} from '../lib/glide-coverage-scenarios.mjs';
const m=JSON.parse(fs.readFileSync(new URL('../data/san-francisco/glide-coverage-v2.json',import.meta.url)));
