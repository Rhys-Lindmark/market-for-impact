...
export function buildSfSffGrants({ source, irsUniverse, candidateUniverse, diligence }) {
  ...
  return {
    version: 'sf-sff-community-grants-v0.1',
    ...
    interpretation: {
      ...
      identity: 'Crosswalks use only exact Unicode-, whitespace-, and case-normalized source names. They are discovery links, not legal-entity or EIN verification; fuzzy matching is prohibited.',
...
export function validateSfSffGrants(snapshot) {
  if (snapshot.version !== 'sf-sff-community-grants-v0.1') throw new Error('Unexpected SFF community-grants version.');
