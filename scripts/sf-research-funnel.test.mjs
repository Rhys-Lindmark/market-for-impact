...
test('builds a nested research funnel without implying impact', () => {
  ...
  assert.deepEqual(snapshot.summary, { universeCount: 6688, machineEligibleCount: 1103, shallowScreenCount: 1000, priorityReviewCount: 100, deepDiveQueueCount: 25, completedInitialReviewCount: 24, exploratoryModelCount: 24, completedCostEffectivenessCount: 0 });
